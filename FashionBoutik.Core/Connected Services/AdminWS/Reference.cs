...
namespace AdminWS
{
    ...
    static partial void ConfigureEndpoint(System.ServiceModel.Description.ServiceEndpoint serviceEndpoint, System.ServiceModel.Description.ClientCredentials clientCredentials);
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.WcfAdminSoapService))
            {
                return new System.ServiceModel.EndpointAddress("https://partnerweb.sveaekonomi.se/WebPayAdminService_Test/AdminService.svc/secure" +
                        "");
            }
            if ((endpointConfiguration == EndpointConfiguration.AdminSoapService))
            {
                return new System.ServiceModel.EndpointAddress("https://partnerweb.sveaekonomi.se/WebPayAdminService_Test/AdminService.svc/backwa" +
                        "rd");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
