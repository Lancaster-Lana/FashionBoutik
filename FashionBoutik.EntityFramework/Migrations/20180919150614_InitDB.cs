        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(nullable: false),
                    FromColor = table.Column<int>(nullable: false),
                    Name = table.Column<string>(nullable: false),
                    ToColor = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(nullable: false),
                    CurrencyBase = table.Column<short>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(nullable: true),
                    Name = table.Column<string>(nullable: false),
                    RetailerUrl = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Retailers_Address_AddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Acronym = table.Column<int>(nullable: false),
                    CreatedDate = table.Column<DateTime>(nullable: false),
                    Description = table.Column<string>(nullable: true),
                    Name = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BinaryObjects_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsersGroupId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "UsersToUsersGroup",
                columns: table => new
                {
                    UserId = table.Column<int>(nullable: false),
                    UsersGroupId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersToUsersGroup", x => new { x.UserId, x.UsersGroupId });
                    table.ForeignKey(
                        name: "FK_UsersToUsersGroup_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsersToUsersGroup_UsersGroups_UsersGroupId",
                        column: x => x.UsersGroupId,
                        principalTable: "UsersGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BinaryObjects_CreatorUserId",
                table: "BinaryObjects",
                column: "CreatorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_BinaryObjects_ProductId",
                table: "BinaryObjects",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersToUsersGroup_UsersGroupId",
                table: "UsersToUsersGroup",
                column: "UsersGroupId");

            migrationBuilder.AddForeignKey(
                name: "FK_BinaryObjects_Users_CreatorUserId",
                table: "BinaryObjects",
                column: "CreatorUserId",
                principalTable: "Users",
                principalColumn: "Id",
