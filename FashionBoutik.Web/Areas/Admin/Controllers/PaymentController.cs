...
namespace FashionBoutik.Web.Controllers
{
    ...
    public class PaymentController : Controller
    {
        ...
        // GET: /order/RemoveQuantity
        [HttpGet]
        public ActionResult RemoveQuantity(string id = "")
        {
        ...
        [HttpPost]
        public ActionResult SetDiscountCode(FormCollection collection)
        {
            // Get all the form values
            string discount_code = collection["txtDiscountCode"];
        ...
        [HttpPost]
        public ActionResult AddGiftCard(FormCollection collection)
        {
            // Get all the form values
        ...
        [HttpGet]
        public ActionResult DeleteGiftCard(string id = "")
        {
            // Get the list of gift cards
            List<GiftCard> giftCards = (List<GiftCard>)Session["GiftCards"];
        ...
        public ActionResult CreatePayPalPayment(Order order, List<OrderRow> orderRows, Domain domain, KeyStringList tt)
        {
            ...
            try
            {
                ...
                var transaction = new PayPal.Api.Payments.Transaction();
        ...
        public ActionResult payson_confirmation(Int32 id = 0)
        {
            ...
            var paysonApi = new PaysonIntegration.PaysonApi(userId, md5Key, null, paysonTest);
        ...
        public ActionResult CreateSveaPayment(Order order, List<OrderRow> orderRows, Domain domain, KeyStringList tt, string paymentType)
        {
            ...
            CreateOrderBuilder orderBuilder = Webpay.Integration.CSharp.WebpayConnection.CreateOrder(sveaConfiguration);
            ...
            for (int i = 0; i < orderRows.Count; i++)
            {
                ...
                OrderRowBuilder orderItem = new Webpay.Integration.CSharp.Order.Row.OrderRowBuilder();
            ...
            if (order.customer_type == 0) // Company
            {
                ...
                CompanyCustomer company = new Webpay.Integration.CSharp.Order.Identity.CompanyCustomer();
            ...
            else if (paymentType == "CREDITCARD")
            {
                ...
                PaymentMethodPayment payment = orderBuilder.UsePaymentMethod(Webpay.Integration.CSharp.Util.Constant.PaymentMethod.KORTCERT);
        ...
        public ActionResult svea_confirmation(FormCollection collection, Int32 id = 0)
        {
            ...
            SveaResponse sveaResponse = new Webpay.Integration.CSharp.Response.Hosted.SveaResponse(response);
