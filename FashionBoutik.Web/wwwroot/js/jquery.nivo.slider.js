...
(function ($) {
    ...
    var NivoSlider = function (element, options) {
        ...
        /*NOTE: set main 'preview' image (selected in the menu)*/
        slider.css('background', 'url("' + vars.currentImage.attr('src') + '") no-repeat');

        var imageCaption = '<div class="nivo-caption draggable-demo-product-header "><p></p></div>';
        slider.prepend($(imageCaption).css({ display: 'none', opacity: settings.captionOpacity }));
        ...
        //set price
        var price = '$12'; //TODO:'<span class="currency"> $ </span>' + priceAmount; //TODO:
        var priceCaption = '<div class="icon-plus-overlay">'
        ...
        slider.append($(priceCaption));
        //$('.nivo-caption').wrapInner(priceCaption);
        ...
        //TO make it draggable for shopping Cart
        //$(slider).each(function () {
        //    $(this).addClass('draggable-demo-product');
        //});

        /*Menu to select image for preview*/
        ...
        /* Create horisontal\vertical slices */
        ...
        var nivoRun = function (slider, kids, settings, nudge) {
            ...
            processCaption(settings); $('.nivo-slice', slider).remove();
            $('.nivo-box', slider).remove();
            if (settings.effect == 'random') {
                var anims = new Array('sliceDownRight', 'sliceDownLeft', 'sliceUpRight', 'sliceUpLeft', 'sliceUpDown', 'sliceUpDownLeft', 'fold', 'fade', 'boxRandom', 'boxRain', 'boxRainReverse', 'boxRainGrow', 'boxRainGrowReverse'); vars.randAnim = anims[Math.floor(Math.random() * (anims.length + 1))];
            ...
            if (settings.effect == 'sliceDown' || settings.effect == 'sliceDownRight' || vars.randAnim == 'sliceDownRight' || settings.effect == 'sliceDownLeft' || vars.randAnim == 'sliceDownLeft') {
                ...
                slices.each(function () {
                    ...
                    if (i == settings.slices - 1) {
                        setTimeout(function () {
                            slice.animate({ height: '100%', opacity: '1.0' },
                ...
                createSlices(slider, settings, vars); var firstSlice = $('.nivo-slice:first', slider);
                ...
                boxes.each(function () {
                    ...
                    if (colIndex == settings.boxCols) {
                        rowIndex++; colIndex = 0; box2Darr[rowIndex] = new Array();
                    }
                });
